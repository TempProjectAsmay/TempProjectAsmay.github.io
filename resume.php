          ...
          <div class=" container-fluid   container-fixed-lg">
            <div id="rootwizard" class="m-t-50">
              ...
              <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm" role="tablist" data-init-reponsive-tabs="dropdownfx">
                <li class="nav-item">
                  <a class="" data-toggle="tab" href="#tab1" role="tab"><i class="fa fa-edit tab-icon"></i> <span>Basic information</span></a>
                </li>
                <li class="nav-item">
                  <a class="" data-toggle="tab" href="#tab2" role="tab"><i class="fa fa-credit-card tab-icon"></i> <span>Qualification</span></a>
                </li>
                <li class="nav-item">
                          ...
                          <div class="form-group-attached">
                            ...
                            <div class="form-group form-group-default input-group">
                              ...
                              <div class="form-input-group flex-1">
                                <label>About</label>
								<textarea class="form-control" name= "about" placeholder="About Yourself"></textarea>
                              </div>
                            </div>
                          </div>
                        </form>
